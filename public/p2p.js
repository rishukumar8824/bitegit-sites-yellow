...
var PM_ICONS = {
  UPI: '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#fff"/><defs><linearGradient id="upiL" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#f7941d"/><stop offset="100%" stop-color="#ed1c24"/></linearGradient></defs><path d="M10 26 L20 9 L30 26 Z" fill="url(#upiL)"/><rect x="15" y="20" width="10" height="2.5" rx="1.2" fill="#fff"/><text x="20" y="35" text-anchor="middle" font-size="5.5" font-weight="700" fill="#53565a" font-family="Arial,sans-serif" letter-spacing="1">UPI</text></svg>',
  ...
  Paytm: '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#002970"/><text x="20" y="23" text-anchor="middle" font-size="12" font-weight="900" fill="#00b9f1" font-family="Arial,sans-serif">Pay</text><text x="28" y="23" text-anchor="middle" font-size="8" font-weight="700" fill="#fff" font-family="Arial,sans-serif">tm</text></svg>',
  PhonePe: '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#5f259f"/><path d="M14 8 L14 32 L20 32 C27 32 31 28 31 22 C31 16 27 13 21 13 L19 13 L19 8 Z" fill="#fff"/><path d="M19 19 L21 19 C24 19 25 21 25 22 C25 24 24 26 21 26 L19 26 Z" fill="#5f259f"/></svg>',
  'Google Pay': '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#fff"/><path d="M28 20.5 L20.5 20.5 L20.5 23.5 L25 23.5 C24.3 25.7 22.3 27 20 27 C17 27 14.5 24.5 14.5 21.5 C14.5 18.5 17 16 20 16 C21.4 16 22.6 16.5 23.6 17.4 L25.7 15.3 C24.1 13.9 22.2 13 20 13 C15.3 13 11.5 16.8 11.5 21.5 C11.5 26.2 15.3 30 20 30 C24.7 30 28.5 26.2 28.5 21.5 C28.5 21.2 28.5 20.8 28.4 20.5 Z" fill="#4285f4"/><path d="M12.7 18.1 L10.2 16.2 C9 18 8.5 20.1 8.5 21.5 C8.5 23 9 25.1 10.2 26.9 L12.7 25 C12 23.9 11.5 22.7 11.5 21.5 C11.5 20.3 12 19.2 12.7 18.1 Z" fill="#ea4335"/><path d="M20 34 C22.8 34 25.3 33 27.2 31.4 L24.9 29.3 C23.7 30.2 22 30.8 20 30.8 C17.1 30.8 14.7 29 13.7 26.5 L11 28.5 C13 31.7 16.3 34 20 34 Z" fill="#34a853"/><path d="M20 8 C16.3 8 13 10.3 11 13.5 L13.7 15.5 C14.7 13 17.1 11.2 20 11.2 C21.8 11.2 23.4 11.8 24.7 12.8 L27.1 10.4 C25.2 9 22.7 8 20 8 Z" fill="#fbbc05"/></svg>',
  ...
  'Digital eRupee': '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#1565c0"/><text x="20" y="29" text-anchor="middle" font-size="22" font-weight="700" fill="#fff" font-family="Arial,sans-serif">₹</text></svg>'
};
