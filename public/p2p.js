...
function renderOffers(data, append) {
  ...
  data.offers.forEach((offer, index) => {
    ...
    const _BADGE_SVG = {
      ...
      4: `<svg viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg" style="width:22px;height:22px;vertical-align:middle;margin-left:4px;cursor:pointer;" onclick="event.stopPropagation();openMerchantBadgeSheet&&openMerchantBadgeSheet(4)"><path d="M3 3 L30 3 L41 14 L41 41 L3 41 Z" fill="#e53560"/><text x="21" y="28" text-anchor="middle" font-size="14" font-weight="800" fill="#fff" font-family="Arial,sans-serif" font-style="italic">Pro</text></svg>`
    };
