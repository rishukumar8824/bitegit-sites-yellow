...
function renderOffers(data, append) {
  ...
  data.offers.forEach((offer, index) => {
    ...
    const _BADGE_SVG = {
      ...
      4: `<span style="display:inline-flex;align-items:center;justify-content:center;background:#e53935;color:#fff;font-size:10px;font-weight:900;padding:2px 6px;border-radius:5px;margin-left:4px;vertical-align:middle;line-height:1.2;cursor:pointer;letter-spacing:0.3px;" onclick="event.stopPropagation();openMerchantBadgeSheet&&openMerchantBadgeSheet(4)">Pro</span>`
    };
