...
var PM_ICONS = {
  UPI: '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#fff"/><defs><linearGradient id="upiG" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#f7941d"/><stop offset="100%" stop-color="#ed1c24"/></linearGradient></defs><polygon points="20,8 32,28 8,28" fill="url(#upiG)"/><rect x="17" y="22" width="6" height="3" rx="1" fill="#fff"/></svg>',
  'Bank Transfer(India)': '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#1a73e8"/><rect x="7" y="30" width="26" height="2.5" rx="1" fill="#fff"/><rect x="7" y="18" width="26" height="2" rx="1" fill="#fff"/><rect x="9" y="20" width="3" height="10" rx="1" fill="#fff"/><rect x="14" y="20" width="3" height="10" rx="1" fill="#fff"/><rect x="20" y="20" width="3" height="10" rx="1" fill="#fff"/><rect x="25" y="20" width="3" height="10" rx="1" fill="#fff"/><polygon points="20,8 33,18 7,18" fill="#fff"/></svg>',
  Paytm: '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#002970"/><text x="20" y="21" text-anchor="middle" font-size="10" font-weight="800" fill="#00baf2" font-family="Arial,sans-serif">Pay</text><text x="20" y="29" text-anchor="middle" font-size="7" font-weight="600" fill="#fff" font-family="Arial,sans-serif">tm</text></svg>',
  PhonePe: '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#5f259f"/><circle cx="20" cy="13" r="5" fill="#fff"/><path d="M15 18 Q15 30 20 30 Q25 30 25 18" stroke="#fff" stroke-width="2.5" fill="none"/><circle cx="20" cy="12" r="2.5" fill="#5f259f"/><text x="20" y="15" text-anchor="middle" font-size="7" font-weight="800" fill="#fff" font-family="Arial,sans-serif">Pe</text></svg>',
  'Google Pay': '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#fff"/><text x="20" y="26" text-anchor="middle" font-size="20" font-weight="700" fill="#4285f4" font-family="Arial,sans-serif">G</text><path d="M20 16 L28 16" stroke="#4285f4" stroke-width="3" stroke-linecap="round"/><path d="M20 16 L20 23" stroke="#4285f4" stroke-width="3" stroke-linecap="round"/><circle cx="20" cy="20" r="9" stroke="#4285f4" stroke-width="0" fill="none"/><text x="20" y="26" text-anchor="middle" font-size="19" font-weight="800" fill="none" stroke="#fbbc05" stroke-width="0" font-family="Arial,sans-serif">G</text><path d="M14 13 Q20 8 26 13" stroke="#ea4335" stroke-width="2.2" fill="none" stroke-linecap="round"/><path d="M26 13 Q31 19 26 27" stroke="#34a853" stroke-width="2.2" fill="none" stroke-linecap="round"/><path d="M26 27 Q20 32 14 27" stroke="#fbbc05" stroke-width="2.2" fill="none" stroke-linecap="round"/><path d="M14 27 Q9 19 14 13" stroke="#4285f4" stroke-width="2.2" fill="none" stroke-linecap="round"/><text x="20" y="25" text-anchor="middle" font-size="14" font-weight="800" fill="#4285f4" font-family="Arial,sans-serif">G</text></svg>',
  'Bank Transfer(Union Bank)': '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#c05c00"/><rect x="6" y="14" width="28" height="4" rx="2" fill="#f5c842"/><rect x="6" y="20" width="28" height="4" rx="2" fill="#f5c842"/><rect x="6" y="26" width="28" height="4" rx="2" fill="#f5c842"/></svg>',
  GoPay: '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#00aed6"/><circle cx="20" cy="20" r="11" fill="#fff"/><text x="20" y="25" text-anchor="middle" font-size="11" font-weight="800" fill="#00aed6" font-family="Arial,sans-serif">Go</text></svg>',
  'Bank Jago': '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#ff4d00"/><text x="20" y="27" text-anchor="middle" font-size="20" font-weight="900" fill="#fff" font-family="Arial,sans-serif">J</text><path d="M16 31 Q20 34 24 31" stroke="#fff" stroke-width="2" fill="none" stroke-linecap="round"/></svg>',
  'A-Bank': '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#2e7d32"/><circle cx="20" cy="16" r="7" fill="#4caf50"/><path d="M17 13 Q20 10 23 13 Q20 11 17 13z" fill="#8bc34a"/><path d="M20 10 L20 7" stroke="#8bc34a" stroke-width="2" stroke-linecap="round"/><text x="20" y="32" text-anchor="middle" font-size="9" font-weight="700" fill="#fff" font-family="Arial,sans-serif">A-Bank</text></svg>',
  NETELLER: '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#8dc63f"/><text x="20" y="28" text-anchor="middle" font-size="22" font-weight="900" fill="#fff" font-family="Arial,sans-serif">N</text></svg>',
  'Volet.com(Formerly Advcash)': '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#b5a800"/><text x="20" y="23" text-anchor="middle" font-size="9" font-weight="700" fill="#fff" font-family="Arial,sans-serif">volet</text><rect x="10" y="25" width="20" height="2" rx="1" fill="rgba(255,255,255,0.5)"/></svg>',
  Cashapp: '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#00d632"/><text x="20" y="28" text-anchor="middle" font-size="22" font-weight="900" fill="#fff" font-family="Arial,sans-serif">$</text></svg>',
  'STC PAY': '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#6122a0"/><text x="20" y="20" text-anchor="middle" font-size="10" font-weight="800" fill="#fff" font-family="Arial,sans-serif">stc</text><rect x="10" y="22" width="20" height="1.5" rx="1" fill="rgba(255,255,255,0.4)"/><text x="20" y="30" text-anchor="middle" font-size="8" font-weight="600" fill="#d4aaff" font-family="Arial,sans-serif">pay</text></svg>',
  'Transfers with specific bank': '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#1565c0"/><rect x="7" y="30" width="26" height="2.5" rx="1" fill="#fff"/><rect x="7" y="18" width="26" height="2" rx="1" fill="#fff"/><rect x="9" y="20" width="3" height="10" rx="1" fill="#fff"/><rect x="14" y="20" width="3" height="10" rx="1" fill="#fff"/><rect x="20" y="20" width="3" height="10" rx="1" fill="#fff"/><rect x="25" y="20" width="3" height="10" rx="1" fill="#fff"/><polygon points="20,8 33,18 7,18" fill="#fff"/><path d="M28 24 L32 24 M30 22 L32 24 L30 26" stroke="#fff" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>',
  'Cash Deposit to Bank': '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#795548"/><rect x="10" y="16" width="20" height="14" rx="3" fill="#fff" opacity="0.9"/><rect x="10" y="16" width="20" height="4" rx="2" fill="#5d4037"/><rect x="17" y="10" width="6" height="8" rx="3" fill="#fff" opacity="0.9"/><rect x="14" y="22" width="5" height="3" rx="1" fill="#795548"/><rect x="21" y="22" width="5" height="3" rx="1" fill="#795548"/></svg>',
  'Western Union': '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#fdd835"/><text x="20" y="26" text-anchor="middle" font-size="14" font-weight="900" fill="#000" font-family="Arial,sans-serif">WU</text></svg>',
  'Faster Payment System': '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#1a237e"/><rect x="7" y="7" width="11" height="11" rx="2" fill="#e53935"/><rect x="22" y="7" width="11" height="11" rx="2" fill="#fff"/><rect x="7" y="22" width="11" height="11" rx="2" fill="#fff"/><rect x="22" y="22" width="11" height="11" rx="2" fill="#43a047"/><text x="27" y="19" text-anchor="middle" font-size="7" font-weight="800" fill="#1a237e" font-family="Arial,sans-serif">FPS</text></svg>',
  GeoPay: '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#f9a825"/><text x="20" y="19" text-anchor="middle" font-size="8" font-weight="800" fill="#000" font-family="Arial,sans-serif">GEO</text><rect x="10" y="21" width="20" height="1.5" rx="1" fill="rgba(0,0,0,0.3)"/><text x="20" y="30" text-anchor="middle" font-size="8" font-weight="700" fill="#000" font-family="Arial,sans-serif">pay</text></svg>',
  'Digital eRupee': '<svg viewBox="0 0 40 40" width="40" height="40"><rect width="40" height="40" rx="10" fill="#1565c0"/><text x="20" y="28" text-anchor="middle" font-size="20" font-weight="700" fill="#fff" font-family="Arial,sans-serif">₹</text></svg>'
};
