...
function renderOffers(data, append) {
  ...
  data.offers.forEach((offer, index) => {
    ...
    const _BADGE_SVG = {
      ...
      4: `<svg viewBox="0 0 36 30" fill="none" xmlns="http://www.w3.org/2000/svg" style="width:26px;height:21px;vertical-align:middle;margin-left:4px;cursor:pointer;" onclick="event.stopPropagation();openMerchantBadgeSheet&&openMerchantBadgeSheet(4)"><path d="M2 2 L25 2 L34 11 L34 28 L2 28 Z" fill="#e53560" rx="2"/><text x="17" y="21" text-anchor="middle" font-size="12" font-weight="800" fill="#fff" font-family="Arial,sans-serif" font-style="italic">Pro</text></svg>`
    };
