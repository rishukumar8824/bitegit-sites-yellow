...
const SELLER_ACTIVE_ORDER_STATUSES = ['CREATED', 'PAYMENT_SENT', 'PENDING', 'PAID', 'DISPUTED'];
  ...
  async function createEscrowOrder(orderInput) {
    ...
    try {
      const result = await runInTransaction(async (session) => {
        ...
        // Seller can have multiple concurrent orders (restriction removed)
              ...
              messages: {
                ...
                text:
                  targetStatus === 'EXPIRED'
                    ? 'Order expired. Reserved ad liquidity was restored.'
