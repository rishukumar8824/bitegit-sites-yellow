...
function createRepositories(collections) {
  ...
  async function updateOffer(offerId, userId, fields) {
    const allowed = ['price', 'minLimit', 'maxLimit', 'payments', 'status', 'remark', 'totalAmount', 'available', 'availableAmount'];
  ...
  async function listP2POrderHistory(userId, { limit = 50, offset = 0 } = {}) {
